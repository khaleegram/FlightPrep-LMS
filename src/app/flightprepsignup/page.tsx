...
export default function AdminSignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // NOTE: In a real app, you would now call a Firebase Function
      // to set the `isAdmin` custom claim on this new user.
      // Since we can't do that from the frontend, the user will need to be
      // promoted manually in the backend for now.

      toast({ 
        title: 'Admin Account Created', 
        description: 'Please ask an existing super-admin to grant you admin privileges.' 
      });
